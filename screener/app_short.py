...
with st.sidebar:
    ...
    manual_tickers = st.text_area(
        ...
        value="NVDA, TSLA, IBIT, INTC, NFLX, AAPL, AMZN, NIO, SOFI, PLTR, AMD, GOOGL, RIVN, MSTR, META, BAC, AAL, SMCI, MARA, IREN, GRAB, MSFT, WBD, WULF, AVGO, ORCL, VALE, CORZ, JD, HOOD, F, CRWV, PYPL, SNAP, BABA, EOSE, GOOG, ETHA, MU, LCID, NKE, NU, TSM, C, BMNR, UNH, RIOT, UBER, CMCSA, FCX, B, CIFR, CMG, COIN, PBR, GME1, VZ, CLSK, PDD, CCL, GME, MRVL, BULL, T, BBAI, BA, WFC, OXY, KVUE, ASTS, ET, LYFT, OPEN, WMT, XOM, CSCO, HIMS, ACHR, PATH, RKT, AG, RKLB, ONDS, ARM, TTD, RGTI, SLB, NEM, APLD, HTZ, DKNG, QBTS, QS, POET, SOUN, U, NBIS, TGT, PSKY, BE, SBET, CLF, JPM, DAL, SBUX, RUN, OSCR, CRCL, DIS, NOK, UUUU, DJT, KO, SMR, XPEV",
        height=110,
